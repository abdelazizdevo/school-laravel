        ...
        <div class="modal-content">
            <form method="POST">
                ...
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <div class="form-floating mb-7">
                            <input type="text" class="form-control" name="student[group_name]" value="{{ isset($student) ? $student->group_name : '' }}"/>
                            <label for="floatingInput">المجموعه</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-floating mb-7">
                            <input type="text" class="form-control" name="student[center_name]" value="{{ isset($student) ? $student->center_name : '' }}"/>
                            <label for="floatingInput">السنتر</label>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="form-floating mb-7">
                            <input type="text" class="form-control" name="student[school_name]" value="{{ isset($student) ? $student->school_name : '' }}"/>
                            <label for="floatingInput">اسم المدرسه</label>
                        </div>
                    </div>
